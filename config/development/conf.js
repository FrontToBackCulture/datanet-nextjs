const config = {
  ...
  outlet: {
    ...
    listFields: {
      ...
      metric3: { sourceColumn: 'Net Credit Day', link: false, type: 'currency' },
      metric4: { sourceColumn: 'Net Cash Day', link: false, type: 'currency' },

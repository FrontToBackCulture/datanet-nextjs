  ...
  product: {
    ...
    detailFields: {
      latestMetric: {
        ...
        link: false,
        type: 'number',
        headerName: 'Last Working Day Qty Sales',
      },
      priorMetric: {
        sourceColumn: 'priorMetric',
        link: false,
        type: 'number',
        headerName: 'Prior Working Day Qty Sales',
      },
      metric1: {
        sourceColumn: 'changeMetricPercent',
        link: false,
  ...
  promotion: {
    ...
    listFields: {
      ...
      metric2: {
        ...
        link: false,
        type: 'currency',
        headerName: 'Promo Net Sales L3M',
        maxWidth: 150,
      },
    },
    detailFields: {
      latestMetric: {
        ...
        link: false,
        type: 'number',
        headerName: 'Last Working Day Promo Used Count',
      },
      priorMetric: {
        sourceColumn: 'priorMetric',
        link: false,
        type: 'number',
        headerName: 'Prior Working Day Promo Used Count',
      },
      metric1: {
        sourceColumn: 'changeMetricPercent',
        link: false,

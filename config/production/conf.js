const config = {
  ...
  outlet: {
    ...
    listFields: {
      ...
      //   type: 'decimal',
      // },
      metric2: { sourceColumn: 'sum Order Count', link: false, type: 'currency' },
      metric3: { sourceColumn: 'max Net Sales', link: false, type: 'currency' },
      metric4: { sourceColumn: 'min Net Sales', link: false, type: 'decimal' },
      metric5: { sourceColumn: 'average Order Count', link: false, type: 'decimal' },
      // metric6: { sourceColumn: 'Count Storehub', link: false, type: 'decimal' },
    },
    detailFields: {
      metric1: { sourceColumn: 'sum Net Sales', link: false, type: 'currency' },
